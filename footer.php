		...
		<div id="site-bottom" class="clear">
			...
			<div class="site-info">
				...
				<?php
						...
						$author_uri = 'https://www.freshthemes.com/themes/revenue';
				?>

				&copy; <?php echo date("o"); ?> <a href="<?php echo home_url(); ?>"><?php echo get_bloginfo('name'); ?></a> - <a target="_blank" href="https://www.freshthemes.com/themes/revenue">Upgrade to PRO version</a>
